...
check(server.includes('cleanDataDir();') && server.includes('actual.init(initConfig)') && server.includes('actual.downloadBudget(budgetId)'), 'server.js worker should initialize and download Actual budgets');
